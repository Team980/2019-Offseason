...
//  public static final double kDefaultQuickStopAlpha = 0.1;
   ...
   */
  public DifferentialDrive980(SpeedController leftMotor, SpeedController rightMotor) {
    ...
    instances++;
    setName("DifferentialDrive980", instances);
...
//  @SuppressWarnings("ParameterName")
  ...
  public String getDescription() {
    return "DifferentialDrive980";
  }

  @Override
  public void initSendable(SendableBuilder builder) {
    builder.setSmartDashboardType("DifferentialDrive980");
